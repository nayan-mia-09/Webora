...
const ContactUs = () => {
    ...
    formData.append("access_key", "99f4e733-84b4-481d-8672-62a67ac0f6b5");
        ...
        <div>
         ...
         <div>
            ...
            <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                ...
                <input type="eamil" name="email" id="" placeholder='Enter your email' className='w-full p-3 text-sm outline-none' required/>
            </div>
        </div>
